...
![](images/Pasted%20image%2020221125164243.png)
...
![](images/Pasted%20image%2020221125184443.png)
...
![](images/Pasted%20image%2020221126225851.png)
...
![](images/Pasted%20image%2020221128110929.png)
### ②项目的不同运行环境
...
|开发环境|测试环境|生产环境|
|:-----|:-----|:-----|
|dev.driver=com.mysql.jdbc.Driver</br>dev.url=jdbc:mysql://124.71.36.17:3306/db-sys  <br>dev.username=dev</br> dev.password=wck</br>|dev.driver=com.mysql.jdbc.Driver</br>dev.url=jdbc:mysql://124.71.36.17:3306/db-sys  <br>dev.username=test</br> dev.password=wck</br>|dev.driver=com.mysql.jdbc.Driver</br>dev.url=jdbc:mysql://124.71.36.17:3306/db-sys  <br>dev.username=prod</br> dev.password=wck</br>|
